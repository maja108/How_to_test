...
const test_type ='integration tests'
const result_positive = 'passed'
const result_negative = 'failed'
let result_confused = 'complicated'


//console.log(test_type + " " + result_positive + " "+ result_negative)
//console.log (`${test_type}: ${result_negative}`)
//console.log (`${test_type}: ${result_positive}`)
console.log (result_confused)
result_confused += " it is"
console.log(result_confused)
